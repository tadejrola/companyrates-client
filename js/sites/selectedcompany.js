$(document).ready(function () {
    ...
    if (searchParams.has('companyid')) {
        ...
        $.ajax({
            url: "http://companyratesapi-prod.eu-west-2.elasticbeanstalk.com/api/companies/" + param,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                ...
                $.ajax({
                    url: "http://companyratesapi-prod.eu-west-2.elasticbeanstalk.com/api/reviews/" + param,
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
        ...
        $("#btn_compnay_thumbsup").click(function () {
            ...
            $.ajax({
                url: "http://companyratesapi-prod.eu-west-2.elasticbeanstalk.com/api/votecompanies?sessionkey=" + items.SessionKey,
                type: 'POST',
                dataType: 'json',
        ...
        $("#btn_addReview").click(function () {
            ...
            $.ajax({
                url: "http://companyratesapi-prod.eu-west-2.elasticbeanstalk.com/api/reviews?sessionkey=" + items.SessionKey,
                type: 'POST',
                dataType: 'json',
                data: reviewData,
                success: function (data) {
        ...
        $("#btn_removeCompany").click(function () {
            if (items.isAdmin == true) {
                $.ajax({
                    url: "http://companyratesapi-prod.eu-west-2.elasticbeanstalk.com/api/companies/" + param + "?sessionkey=" + items.SessionKey,
                    type: 'DELETE',
                    dataType: 'json',
...
function ThumbsDownReview(el) {
    ...
    $.ajax({
        url: "http://companyratesapi-prod.eu-west-2.elasticbeanstalk.com/api/votereviews?sessionkey=" + items.SessionKey,
        type: 'POST',
        dataType: 'json',
...
function RemoveReview(el) {
    ...
    if (items.isAdmin == true) {
        $.ajax({
            url: "http://companyratesapi-prod.eu-west-2.elasticbeanstalk.com/api/reviews/" + id + "?sessionkey=" + items.SessionKey,
            type: 'DELETE',
            dataType: 'json',
